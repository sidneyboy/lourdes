...
@section('main-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Paid Downpayment</div>
                <div class="card-body">
                    <form action="{{ route('search_paid_downpayment') }}" method="get">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                @foreach ($reservations as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModalAmount{{ $data->id }}"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
