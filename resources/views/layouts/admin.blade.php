...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #ff8008">
            ...
            <!-- Nav Item - Profile -->
            {{-- <li class="nav-item {{ Nav::isRoute('accomodation_type') }}">
                <a class="nav-link" href="{{ route('accomodation_type') }}">
                    <i class="fas fa-fw fa-user"></i>
                    <span>{{ __('Accomodation Type (+)') }}</span>
                </a>
            </li> --}}
